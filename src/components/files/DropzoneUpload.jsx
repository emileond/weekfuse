...
const DropzoneUpload = ({
    ...
    const imgFolder = theme.includes('dark') ? 'dark' : 'light';
    ...
    const activeClass =
        isDragActive && !isDragCancelled ? 'z-10 bg-secondary-200/90' : 'bg-transparent';
        ...
        return (
            <div {...getRootProps()}>
                {isDragActive && !isDragCancelled && (
                    ...
                    >
                        <p className="font-semibold text-4xl">Drop it like it&apos;s hot!</p>
                    </div>
                )}
                {children}
            </div>
            ...
            {isDragActive ? (
                ...
                <div className="flex flex-col gap-6">
                    <div>
                        ...
                        />
                        <p className="font-medium text-default-500">Drag & drop some files here</p>
                    </div>
