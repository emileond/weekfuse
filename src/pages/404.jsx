...
function NotFoundPage() {
    ...
    const empty = theme.includes('dark') ? emptyDark : emptyLight;
    return (
        <div className="w-screen h-screen py-12 flex flex-col gap-9 justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center gap-3">
                ...
                <p className="text-xl">
                    Uh-oh, this page doesn&apos;t seem to exist. Let&apos;s get you back on track!
                </p>
                <Button as={Link} to="/" color="primary" variant="shadow" className="mt-4">
                    Go back home
                </Button>
            </div>
        </div>
